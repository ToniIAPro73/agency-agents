...
This repository contains 65 specialized AI agents optimized for Claude Code and Codex workflows.
...
4. **[SDD_INTEGRATION_GUIDE.md](SDD_INTEGRATION_GUIDE.md)** — Understand Spec-Driven Development
workflow
5. **[GITHUB_WORKFLOW_STANDARDS.md](GITHUB_WORKFLOW_STANDARDS.md)** — Understand Git flow and
branch strategy

**Also bookmark**:

- **[AGENT_PERFORMANCE_BASELINES.md](AGENT_PERFORMANCE_BASELINES.md)** — Know what to expect from
agents
...
A: Advanced users can edit agent files in ~/.claude/agents/. See INTEGRATION_GUIDE.md for safer
approaches.
...
You now have access to a world-class team of AI specialists. Use them wisely, share feedback, and
