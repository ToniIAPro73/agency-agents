...
✅ Good: `Use the Backend Architect agent to design a REST API for a real-time chat with 100K
concurrent users.`
...
- **[AGENT_PERFORMANCE_BASELINES.md](AGENT_PERFORMANCE_BASELINES.md)** — What to expect from each
agent
...
If an agent isn't working as expected, see
[AGENT_CHANGELOG.md](AGENT_CHANGELOG.md#reporting-agent-issues).
...
**That's it!** Start with the 5 agents above, then explore `AGENTS.md` for specialized agents as
you need them.
